...
AddressBlocksMinedService.prototype._rapidProtectedUpdateTip = function (height) {
    ...
    self.common.log.info('[AddressBalanceMinedService] Start updt from ', self.lastCheckedBlock + 1, ' to ', height);
    ...
    return this._processLastBlocks(height, function (err) {
        ...
        self.common.log.info('[AddressBalanceMinedService] Updated to ', height);
